...
<head>
    ...
    <title><?php echo $data['title'] ?> - AppU</title>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url() ?>assets/plugins/jquery-step/jquery.steps.css">
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div id="load_screen">
        <div class="loader">
            <div class="loader-content"> <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 792 723" style="enable-background:new 0 0 792 723;" xml:space="preserve">
                    <g>
                        <g>
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="<?php echo base_url() ?>"><img alt="logo" src="<?php echo base_url()?>assets/img/letra-u.png"> <span class="navbar-brand-name">APP U</span></a>
            </div>
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <h6><span><?php echo $this->session->username ?></span></h6>
                            </div>
                        </div>
                    ...
                    <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="user-profile-dropdown">
                        <div class="">
                            ...
                            <div class="dropdown-item">
                                <a class="" href="<?php echo base_url("MainController/LogOut") ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-log-out">
            ...
            <nav id="topbar">
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu active">
                        <a href="<?php echo base_url() ?>" class="dropdown-toggle autodroprown">
                            <div class="">
