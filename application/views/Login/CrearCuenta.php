            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" method="POST" action="<?php echo base_url("LoginController/registrarUsuario") ?>">
                            <div class="form">
                                ...
                                <div id="email-field" class="field-wrapper input">
                                    ...
                                    <input id="email" name="email" type="email" value="" class="form-control" placeholder="Correo electronico...">
                                </div>
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary" value="">Registrarme</button>
                                    </div>
                                </div>
